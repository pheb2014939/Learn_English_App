...
public class BasicCommunicationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_basic_communication);
    ...
    private void GetDataFromFirebase() {
        ...
        Query query = myRef.child("basiccommunication");
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                recyclerAdapter = new RecyclerAdapter(BasicCommunicationActivity.this, vocabularyArrayList);
