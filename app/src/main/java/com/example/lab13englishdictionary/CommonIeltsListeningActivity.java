...
public class CommonIeltsListeningActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_common_ielts_listening);
    ...
    private void GetDataFromFirebase() {
        ...
        Query query = myRef.child("ieltslistening");
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                recyclerAdapter = new RecyclerAdapter(CommonIeltsListeningActivity.this, vocabularyArrayList);
