...
public class AdvanceEnglishCommunicationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_advance_english_communication);
    ...
    private void GetDataFromFirebase() {
        ...
        Query query = myRef.child("AdvancedEnglishCommunication");
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                recyclerAdapter = new RecyclerAdapter(AdvanceEnglishCommunicationActivity.this, vocabularyArrayList);
